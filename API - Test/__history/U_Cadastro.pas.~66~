...
begin
  if Trim(DBEdit2.Text) = '' then
    begin
      ShowMessage('Preencha o campo nome do fornecedor!');
      DBEdit2.SetFocus;
      exit;
      //verifica o campo nome se foi preenchido!
    end;
  if Trim(DBEdit3.Text) = '' then
    begin
      ShowMessage('Preencha o campo CNPJ!');
      DBEdit3.SetFocus;
      exit;
      //verifica o campo CNPJ se foi preenchido!
    end;
